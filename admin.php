        ...
        <div class="main">
            ...
            <div class="sanpham">
                ...
                foreach ($sp->select_all() as $rowname => $row) {
                    echo "<tr>
                        ...
                        <td style='width: 40%'>
                            <a title='Xem chi tiết'" . $row['TenSP'] . "'>" . $row['TenSP'] . "</a>
            ...
            <div class="donhang">
                <table class="table-header">
                    <tr>
                        <!-- Theo độ rộng của table content -->
                        <th  title="Sắp xếp" style="width: 3%" onclick="sortDonHangTable('stt')">Stt <i class="fa fa-sort"></i></th>
                        <th title="Sắp xếp" style="width: 5%" onclick="sortDonHangTable('madon')">Mã đơn <i class="fa fa-sort"></i></th>
                        <th title="Sắp xếp" style="width: 10%" onclick="sortDonHangTable('khach')">Khách <i class="fa fa-sort"></i></th>
                ...
                $hd = new HoaDonBUS();
                $i = 1;
                echo "<table class='table-outline hideImg' style='color:white;' >";
                foreach ($hd->select_all() as $rowname => $row) {
                    echo "<tr>
                        <td style='width: 10%'>" . $i++ . "</td>
                        <td style='width: 15%'>" . $row['MaHD'] . "</td>
                        <td style='width: 20%'>
                                  " . $row['NguoiNhan'] . "                 
                        </td>
                        <td style='width: 24%'>" . number_format($row['TongTien'], 0, ".", ".") . "</td>
                        <td style='margin-right:50px;'>" . $row['NgayLap'] . "</td>
                        <td style='width: 15%'>
                            <div class='tooltip'>
                                <i class='fa fa-wrench' onclick='addKhungSuaSanPham('" . $row['TrangThai'] . "')'></i>
                                <span class='tooltiptext'>Sửa</span>
                            </div>
                            <div class='tooltip'>
                                <i class='fa fa-trash' onclick='xoaSanPham('" . $row['MaHD'] . "', '" . $row['NguoiNhan'] . "')'></i>
                                <span class='tooltiptext'>Xóa</span>
                            </div>
                        </td>
                    </tr>";
