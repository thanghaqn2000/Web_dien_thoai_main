...
function addHeader()
{
	...
	<div class="header group">
        ...
        <div class="logo">
            <a href="index.php">
                <img src="img/logoNTP.png" alt="Trang chủ Smartphone Store" title="Trang chủ Smartphone Store">
            </a>
        </div> <!-- End Logo -->
        <div class="content">
    ...
    <div class="chitietSanpham" style="min-height: 85vh">
        ...
        <div class="comment-area">
            <div class="guiBinhLuan">
                ...
                <input id="btnBinhLuan" type="button"  value="GỬI BÌNH LUẬN" onClick="checkGuiBinhLuan()">
            </div>
            <!-- <h2>Bình luận</h2> -->
...
function addFooter()
{
    ...
    <div class="copy-right">
        <p>
            ...
            <span style="color: #eee; font-weight: bold">Nhóm NTP</span>
        </p>
    </div>';
}
        ...
        <div class=" taikhoan">
            ...
            <div class="tab-content">
                <div id="login">
                    ...
                    <form action="" method="post" name="formDangNhap" onsubmit="return checkDangNhap();">
                        <div class="field-wrap">
                            ...
                            <input name="username" type="text" id="username" required autocomplete="on" />
                        </div> <!-- /user name -->
                        <div class="field-wrap">
                            <label>
                ...
                <div id="signup">
                    ...
                    <form action="dangky_back.php" method="post" name="formDangKy" >
                        <div class="top-row">
                            <div class="field-wrap">
                                <label>
